    ...
    <Card className="w-[450px]">
      ...
      <CardContent >
        <ScrollArea  className="h-[520px] w-full pr-4">  
          {typeof messages[messages.length - 1]?.content != 'string' ? "Gera imagem ao lado do chatBox": messages.map(message=>(
      ...
      <CardFooter>
        <form className="flex w-full gap-2"  onSubmit={handleSubmit}>
          <Input placeholder="No que posso te ajudar" value={input} onChange={handleInputChange}/>
